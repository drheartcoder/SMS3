                      ...
                      @foreach($arr_notification as $key => $notification)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn-to-success btn-bordered btn-fill show-tooltip call_loader btn-delets" href="{{$module_url_path.'/delete/'.base64_encode($notification['id'])}}" title="Delete" onclick="return confirm_action(this,event,'{{translation('do_you_really_want_to_delete_this_record')}}','{{translation("are_you_sure")}}','{{translation('yes')}}','{{translation("no")}}')"><i class="fa fa-trash" ></i></a>

                ...
                <div class="login-wrapper">
                    <div class="main-loginpage">
                        ...
                        <div class="login-content">
                            <!-- BEGIN Login Form -->
                           <form id="form-login" action="{{ url('/') }}/{{ config('app.project.role_slug.student_role_slug') }}/process_login" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Email" class="form-control" id="email" name="email" data-rule-required="true">
                           ...
                           <form id="form-forgot" style="display:none" action="{{ url($student_panel_slug.'/process_forgot_password') }}" method="post" >
                            {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <input type="text" placeholder="Email" class="form-control" id="forget_email"  data-rule-required="true" name="email">
      ...
      <script type="text/javascript">
       ...
       $("#forget_email").keyup(function()
        ...
        $("#forget_email").on('blur',function(){
            ...
            {
                $("#forget_email").next('span').html("Please enter valid email");
            }         
        });

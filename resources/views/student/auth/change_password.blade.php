        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box  box-navy_blue">
                    <div class="box-title">
                        <h3><i class="fa fa-wrench"></i> Change Passward</h3>
                        <div class="box-tool">
                        </div>
                    </div>
                    ...
                    {!! Form::open([ 'url' => $student_panel_slug.'/update_password',
                                 'method'=>'POST',
                                 'id'=>'validation-form1',
                        ...
                        <div class="form-group">
                            <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                               <a class="btn btn btn-primary" href="{{ url('/'.$student_panel_slug.'/change_password') }}">Cancel</a>

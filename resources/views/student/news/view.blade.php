                       ...
                       <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="social-list-main">
                            <div class="user-list-blo detils">
                                <span><i class="fa fa-calendar"></i></span><span><?php echo getDateFormat($arr_news_data['publish_date']).' '.getTimeFormat($arr_news_data['start_time']).' '.translation('to').' '.getDateFormat($arr_news_data['end_date']).' '.getTimeFormat($arr_news_data['end_time']);  ?></span>
                            </div>
                        </div>

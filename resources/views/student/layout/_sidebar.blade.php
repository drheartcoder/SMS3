...
?>
    <!-- BEGIN Container -->
   <div class="container sidebar-navy_blue student-leftbar" id="main-container">
        <!-- BEGIN Sidebar -->
        <div id="sidebar" class="navbar-collapse collapse">
            ...
            <ul class="nav nav-list">
                ...
                <li class="<?php  if($segment2 == 'dashboard'){ echo 'active'; } ?>">
                    <a href="{{url($student_panel_slug.'/dashboard')}}" title="{{translation('dashboard')}}">
                ...
                @if(array_key_exists('calendar.update', $arr_current_user_access) || array_key_exists('calendar.list', $arr_current_user_access))
                    <li class="<?php  if($segment2 == 'calendar'){ echo 'active'; } ?>">
                        <a href="{{url($student_panel_slug.'/calendar')}}" title="{{translation('calender')}}">
                ...
                <li class="<?php  if($segment2 == 'notification_settings'){ echo 'active'; } ?>">
                        ...
                        <ul class="submenu">
                             @if(array_key_exists('notification_settings.update', $arr_current_user_access) || array_key_exists('notification_settings.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'notification_settings'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/notification_settings')}}" title="{{translation('notification_settings')}}">
                ...
                <li class="<?php  if($segment2 == 'timetable' || $segment2 == 'attendance' || $segment2 == 'homework' || $segment2 == 'course_material' || $segment2 == 'student_behaviour' || $segment2 == 'exam' || $segment2 == 'task' || $segment2 == 'canteen_bookings' || $segment2 == 'club' || $segment2 == 'todo'){ echo 'active'; } ?>">
                        ...
                        <ul class="submenu">
                             @if(array_key_exists('timetable.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'timetable'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/timetable')}}" title="{{translation('timetable')}}">
                            ...
                            @if(array_key_exists('attendance.update', $arr_current_user_access) || array_key_exists('attendance.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'attendance'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/attendance')}}" title="{{translation('attendance')}}">
                            ...
                            @if(array_key_exists('homework.update', $arr_current_user_access) || array_key_exists('homework.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'homework'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/homework')}}" title="{{translation('homework')}}">
                            ...
                            @if(array_key_exists('course_material.update', $arr_current_user_access) || array_key_exists('course_material.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'course_material'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/course_material')}}" title="{{translation('course_material')}}">
                                        <span class="icon-dash"><i class="fa fa-book faa-vertical animated-hover"></i></span>
                            ...
                            @if(array_key_exists('exam.update', $arr_current_user_access) || array_key_exists('exam.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'exam'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/exam')}}" title="{{translation('exam')}}">
                                        <span class="icon-dash"><i class="fa fa-book faa-vertical animated-hover"></i></span>
                            ...
                            @if(array_key_exists('task.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'task'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/task')}}" title="{{translation('task')}}">
                            ...
                            @if(array_key_exists('canteen_bookings.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'canteen_bookings'){ echo 'active'; } ?>">
                                    ...
                                    <ul class="submenu-dropdown-toggle childmenu">
                                        ...
                                        @if(array_key_exists('canteen_bookings.list', $arr_current_user_access))
                                        <li style="display: block;" class="<?php  if($segment2 == 'canteen_bookings' && $segment3 == ''){ echo 'active'; } ?>"><a href="{{ url($student_panel_slug.'/canteen_bookings/')}}">{{translation('order_history')}} </a>
                                        </li>
                                        @endif
                                        @if(array_key_exists('canteen_bookings.create', $arr_current_user_access))
                                        <li style="display: block;" class="<?php  if($segment2 == 'canteen_bookings' && $segment3 == 'create'){ echo 'active'; } ?>"><a href="{{ url($student_panel_slug.'/canteen_bookings/create')}}">{{translation('add_booking')}} </a></li>   
                                        @endif
                            ...
                            @if(array_key_exists('transport_bus.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'transport_bus'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/transport_bus')}}"  title="{{translation('transport_bus')}}">
                            ...
                            @if(array_key_exists('club.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'club'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/club')}}"  title="{{translation('club')}}">
                            ...
                            @if(array_key_exists('todo.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'todo'){ echo 'active'; } ?>">
                                    <a href="{{url($student_panel_slug.'/todo')}}" title="{{translation('todo')}}">
                                        <span class="icon-dash"><i class="fa fa-list faa-vertical animated-hover"></i></span>
                                        <span class="mobile-nones">{{translation('todo')}}</span>
                                    </a>
                                </li> 
                            @endif
                ...
                <li class="<?php  if($segment2 == 'suggestions' || $segment2 == 'survey' || $segment2 == 'news' ){ echo 'active'; } ?>">
                                ...
                                <li class="<?php  if($segment2 == 'suggestions'){ echo 'active'; } ?>">
                                    <a href="JavaScript:void(0)" class="dropdown-toggle-submenu"  title="{{translation('suggestions')}}">
                                     ...
                                     <ul class="submenu-dropdown-toggle childmenu">
                                        ...
                                        <li class="<?php  if(Request::segment(2) == 'suggestions' && Request::segment(3) == 'manage'){ echo 'active'; } ?>" style="display: block;"><a href="{{ url($student_panel_slug.'/suggestions/manage')}}">{{translation('manage')}} {{translation('suggestions')}} </a></li>

                                        <li class="<?php  if(Request::segment(2) == 'suggestions' && Request::segment(3) == 'poll_raised'){ echo 'active'; } ?>" style="display: block;"><a href="{{ url($student_panel_slug.'/suggestions/poll_raised')}}">{{translation('manage')}} {{translation('poll_raised')}} {{translation('suggestions')}} </a></li>

                                        @if(array_key_exists('suggestions.list', $arr_current_user_access))
                                          <li class="<?php  if(Request::segment(2) == 'suggestions' && Request::segment(3) == 'create'){ echo 'active'; } ?>" style="display: block;"><a href="{{ url($student_panel_slug.'/suggestions/create')}}">{{translation('create')}} {{translation('suggestion')}} </a></li>
                                        @endif
                        ...
                        @if(array_key_exists('survey.list', $arr_current_user_access))
                            <li class="<?php  if($segment2 == 'survey'){ echo 'active'; } ?>">
                                <a href="{{url($student_panel_slug.'/survey')}}" title="{{translation('survey')}}">
                        ...
                        @if(array_key_exists('news.list', $arr_current_user_access))
                            <li class="<?php  if($segment2 == 'news'){ echo 'active'; } ?>">
                                <a href="{{url($student_panel_slug.'/news')}}" title="{{translation('news')}}">

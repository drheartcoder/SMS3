           ...
           <div class="row">
                <div class="col-md-12">
                    <div class="box  box-navy_blue">
                        <div class="box-title timetable-pjts">
                            <h3><i class="{{$module_icon}}"></i>{{translation('student')}}  {{translation('timetable')}}</h3>
                            <div class="box-tool">
                            </div>
                                              ...
                                              @if(isset($period_no) && $period_no!="")
                                                  @for($i=1; $i<=$period_no; $i++)
                                                   ...
                                                   <?php
                                                    ...
                                                    <tr> 
                                                        <td><div class="font-time-tb">{{translation('period')}} {{$i}}</div><div class="font-time-tm-tbl">{{$period_start_time}} - {{$period_end_time}}</div>
                                                        </td>
                                                             ...
                                                             @foreach($weekly_days as $day => $day_full_name)
                                                                  ...
                                                                  @if(isset($arr_holiday) && in_array($day,$arr_holiday))
                                                                     ...
                                                                     @if($i==1)
                                                                        ...
                                                                        class="sunday-holiday-section"> {{ translation("holiday") }}</td>
                                                                     @endif
                                                                  @elseif($isBreak == 1)

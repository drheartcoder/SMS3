        ...
        <div id="sidebar" class="navbar-collapse collapse">
            ...
            <ul class="nav nav-list">
                ...
                <li class="<?php  if($segment2 == 'dashboard'){ echo 'active'; } ?>">
                    <a href="{{url('/')}}/{{$parent_panel_slug}}/dashboard" title="{{translation('dashboard')}}">
                        <span class="icon-dash"><i class="fa fa-dashboard faa-vertical animated-hover"></i></span>
                        <span class="mobile-nones click-name-hide">Dashboard</span>
                    </a>
                </li>
                ...
                @if(array_key_exists('calendar.update', $arr_current_user_access) || array_key_exists('calendar.list', $arr_current_user_access))
                    <li class="<?php  if($segment2 == 'calendar'){ echo 'active'; } ?>">
                        <a href="{{url($parent_panel_slug.'/calendar')}}" title="{{translation('calendar')}}">
                ...
                <li class="<?php  if($segment2 == 'notification_settings'){ echo 'active'; } ?>">
                        ...
                        <ul class="submenu">
                                @if(array_key_exists('notification_settings.update', $arr_current_user_access) || array_key_exists('notification_settings.list', $arr_current_user_access))
                                    <li class="<?php  if($segment2 == 'notification_settings'){ echo 'active'; } ?>">
                                        <a href="{{url($parent_panel_slug.'/notification_settings')}}" title="{{translation('notification_settings')}}">
                ...
                {{-- my kid --}}
                <li class="<?php  if($segment2 == 'kid_profile' || $segment2 == 'document' || $segment2 == ''){ echo 'active'; } ?>">
                        <a href="JavaScript:void(0)" class="dropdown-toggle" title="{{translation('my_kid')}}">
                            <span class="icon-dash"><i class="fa fa-cog faa-vertical animated-hover"></i></span>
                            <span class="click-name-hide">{{translation('my_kid')}}</span>
                            <b class="arrow fa fa-angle-right"></b>
                        </a>

                        <ul class="submenu">
                            @if(array_key_exists('kid_profile.update', $arr_current_user_access) || array_key_exists('kid_profile.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'kid_profile'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/kid_profile')}}" title="{{translation('kid_profile')}}">
                                        <span class="icon-dash"><i class="fa fa-user faa-vertical animated-hover"></i></span>
                                        <span class="mobile-nones">{{translation('kid_profile')}}</span>
                                    </a>
                                </li> 
                            @endif

                            @if(array_key_exists('document.update', $arr_current_user_access) || array_key_exists('document.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'document'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/document')}}" title="{{translation('document')}}">
                                        <span class="icon-dash"><i class="fa fa-file faa-vertical animated-hover"></i></span>
                                        <span class="mobile-nones">{{translation('manage')}} {{translation('document')}}</span>
                                    </a>
                                </li> 
                            @endif

                            @if(array_key_exists('student_illness.create', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'leave_application'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/leave_application')}}" title="{{translation('leave_application')}}">
                                        <span class="icon-dash"><i class="fa fa-medkit faa-vertical animated-hover"></i></span>
                                        <span class="mobile-nones">{{translation('submit_leave_of_absence')}}</span>
                                    </a>
                                </li> 
                            @endif
                ...
                {{-- features --}}
                <li class="<?php  if($segment2 == 'timetable' || $segment2 == 'attendance' || $segment2 == 'homework' || $segment2 == 'course_material' || $segment2 == 'exam'  || $segment2 == 'task' || $segment2 == 'canteen_bookings' || $segment2 == 'transport_bus' || $segment2 == 'club' || $segment2 == 'payment' || $segment2 =='transactions'){ echo 'active'; } ?>">
                        ...
                        <ul class="submenu">
                            @if(array_key_exists('Timetable.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'timetable'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/timetable')}}" title="{{translation('timetable')}}">
                            ...
                            @if(array_key_exists('attendance.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'attendance'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/attendance')}}" title="{{translation('attendance')}}">
                            ...
                            @if(array_key_exists('homework.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'homework'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/homework')}}" title="{{translation('homework')}}">
                                        <span class="icon-dash"><i class="fa fa-book faa-vertical animated-hover"></i></span>
                                        <span class="mobile-nones">{{translation('homework')}}</span>
                                    </a>
                                </li> 
                            @endif

                            @if(array_key_exists('course_material.update', $arr_current_user_access) || array_key_exists('course_material.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'course_material'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/course_material')}}" title="{{translation('course_material')}}">
                                        <span class="icon-dash"><i class="fa fa-book faa-vertical animated-hover"></i></span>
                                        <span class="mobile-nones">{{translation('course_material')}}</span>
                                    </a>
                                </li> 
                            @endif

                            @if(array_key_exists('exam.update', $arr_current_user_access) || array_key_exists('exam.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'exam'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/exam')}}" title="{{translation('exam')}}">
                                        <span class="icon-dash"><i class="fa fa-book faa-vertical animated-hover"></i></span>
                            ...
                            @if(array_key_exists('task.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'task'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/task')}}" title="{{translation('task')}}">
                            ...
                            @if(array_key_exists('canteen_bookings.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'canteen_bookings'){ echo 'active'; } ?>">
                                    ...
                                    <ul class="submenu-dropdown-toggle childmenu">
                                        ...
                                        @if(array_key_exists('canteen_bookings.list', $arr_current_user_access))
                                        <li style="display: block;" class="<?php  if($segment2 == 'canteen_bookings' && $segment3 == ''){ echo 'active'; } ?>"><a href="{{ url($parent_panel_slug.'/canteen_bookings/')}}">{{translation('order_history')}} </a>
                                        </li>
                                        @endif
                                        @if(array_key_exists('canteen_bookings.create', $arr_current_user_access))
                                        <li style="display: block;" class="<?php  if($segment2 == 'canteen_bookings' && $segment3 == 'create'){ echo 'active'; } ?>"><a href="{{ url($parent_panel_slug.'/canteen_bookings/create')}}">{{translation('add_booking')}} </a></li>   
                                        @endif
                            ...
                            @if(array_key_exists('transport_bus.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'transport_bus'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/transport_bus')}}" title="{{translation('transport_bus')}}">
                            ...
                            @if(array_key_exists('club.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'club'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/club')}}" title="{{translation('club')}}">
                            ...
                            <li class="<?php  if($segment2 == 'payment'  || $segment2 == 'transactions'){ echo 'active'; } ?>">
                                    <a href="JavaScript:void(0)" class="dropdown-toggle-submenu" title="{{translation('canteen_bookings')}}">
                                        <span class="icon-dash"><i class="fa fa-ticket faa-vertical animated-hover"></i></span>
                                        <span>{{translation('payment')}}</span>    
                                        <b class="arrow fa fa-angle-right"></b>
                                    </a>

                                    <ul class="submenu-dropdown-toggle childmenu">
                                        @if(array_key_exists('payment.list', $arr_current_user_access))
                                            <li class="<?php  if($segment2 == 'payment'){ echo 'active'; } ?>">
                                                <a href="{{url($parent_panel_slug.'/payment')}}" title="{{translation('payment')}}">
                                                    <span class="icon-dash"><i class="fa fa-money faa-vertical animated-hover"></i></span>
                                                    <span class="mobile-nones">{{translation('manage')}} {{translation('payment')}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        @if(array_key_exists('payment.list', $arr_current_user_access))
                                            <li class="<?php if($segment2 == 'transactions'){ echo 'active'; } ?>">
                                                <a href="{{url($parent_panel_slug.'/transactions')}}" title="{{translation('payment')}}">
                                                    <span class="icon-dash"><i class="fa fa-exchange faa-vertical animated-hover"></i></span>
                                                    <span class="mobile-nones">{{translation('transactions')}} {{translation('history')}}</span>
                                                </a>
                                            </li>
                                        @endif   
                                    </ul>
                ...
                <li class="<?php  if($segment2 == 'survey' || $segment2 == 'suggestions' || $segment2 == 'news' || $segment2 == 'message' || $segment2 == 'claim'){ echo 'active'; } ?>">
                        ...
                        <ul class="submenu">
                            ...
                            @if(array_key_exists('survey.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'survey'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/survey')}}" title="{{translation('survey')}}">
                                ...
                                <li class="<?php  if($segment2 == 'suggestions'){ echo 'active'; } ?>">
                                    <a href="JavaScript:void(0)" class="dropdown-toggle-submenu" title="{{translation('suggestions')}}">
                                     ...
                                     <ul class="submenu-dropdown-toggle childmenu">
                                        ...
                                        <li style="display: block;"><a href="{{ url($parent_panel_slug.'/suggestions/manage')}}">{{translation('manage')}} {{translation('suggestions')}} </a></li>

                                        <li style="display: block;"><a href="{{ url($parent_panel_slug.'/suggestions/poll_raised')}}">{{translation('manage')}} {{translation('poll_raised')}} {{translation('suggestions')}} </a></li>

                                        @if(array_key_exists('suggestions.list', $arr_current_user_access))
                                          <li style="display: block;"><a href="{{ url($parent_panel_slug.'/suggestions/create')}}">{{translation('create')}} {{translation('suggestion')}} </a></li>
                                        @endif
                            ...
                            @if(array_key_exists('news.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'news'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/news')}}" title="{{translation('news')}}">
                            ...
                            @if(array_key_exists('message.list', $arr_current_user_access))
                                <li class="<?php  if($segment2 == 'message'){ echo 'active'; } ?>">
                                    <a href="{{url($parent_panel_slug.'/message')}}" title="{{translation('message')}}">
                            ...
                            @if($claim_module_access == '1')
                                @if(array_key_exists('claim.list', $arr_current_user_access))
                                    <li class="<?php  if($segment2 == 'claim'){ echo 'active'; } ?>">
                                        <a href="{{url($parent_panel_slug.'/claim')}}" title="{{translation('claim')}}">
                                            <span class="icon-dash"><i class="fa fa-file faa-vertical animated-hover"></i></span>

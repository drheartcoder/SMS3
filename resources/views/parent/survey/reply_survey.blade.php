...
<div id="breadcrumbs">
  <ul class="breadcrumb">
     ...
     <li>
            ...
            <a href="{{url('/')}}/{{ config('app.project.parent_panel_slug') }}/dashboard">{{translation('dashboard')}}</a>
        </li>
        <span class="divider">
                                                ...
                                                if(!empty($arr_options) && $optionType!=''){
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="sb-titl-pro-surv xxques-options-section">
                                                            <!-- <div class="left-fessor-vw-left"> 
                                                                <input type="{{$optionType}}" name="{{$optionName}}" id="{{$key2}}"
                                                                data-rule-required='true' value="{{ $value }}" >
                                                            </div>

...
<div class="page-title new-agetitle">
    <div>
        <h1><i class="{{$module_icon}}"></i>{{translation('calendar')}}</h1>
    ...
    $.ajax({
              ...
              success:function(data){
                if(data)
                {
                  ...
                  ?>
                      $('.fc-day.fc-sun').css("background-color","#D3D3D3");
                  <?php      
                      }

                      if(in_array('Mon',$arr_weekly_offs)){
                  ?>
                      $('.fc-day.fc-mon').css("background-color","#D3D3D3");
                  <?php      
                      }

                      if(in_array('Tue',$arr_weekly_offs)){
                  ?>
                      $('.fc-day.fc-tue').css("background-color","#D3D3D3");
                  <?php      
                      }

                      if(in_array('Wed',$arr_weekly_offs)){
                  ?>
                      $('.fc-day.fc-wed').css("background-color","#D3D3D3");
                  <?php      
                      }
                  ...
                  ?>
                      $('.fc-day.fc-thu').css("background-color","#D3D3D3");
                  <?php      
                      }
                  ...
                  ?>
                      $('.fc-day.fc-fri').css("background-color","#D3D3D3");
                  <?php      
                      }

                      if(in_array('Sat',$arr_weekly_offs)){
                  ?>
                      $('.fc-day.fc-sat').css("background-color","#D3D3D3");
                  <?php      
                      }

      ...
      <div class="box-content">
        ...
        @include('admin.layout._operation_status')
          ...
          <form method="POST" id="validation-form1" onsubmit="return addLoader()"  class="form-horizontal" data-parsley-validate="" action="{{ $module_url_path}}/update">
                ...
                <input type="hidden" name="id" value="{{isset($arr_data['id']) ? base64_encode($arr_data['id']) : ''}}">
                                <div class="row">
                                <div class="col-lg-6">
                                <div class="row">
                                <div class="form-group">
                                      <label class="col-sm-3 col-lg-4 control-label" for="state"> {{translation('fee_name')}}
                                        <i class="red">*</i>
                                       </label>
                                        <div class="col-sm-4 col-lg-8 controls">
                                          
                                            <input type="text" name="name" class="form-control add-stundt" value="{{isset($arr_data['title']) ? $arr_data['title'] : ''}}" placeholder="{{translation('enter_fee_name')}}" data-rule-required="true" pattern="[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$"   />

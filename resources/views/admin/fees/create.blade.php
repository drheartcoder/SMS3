                        ...
                        <div class="row">
                            <div class="form-group">
                                  ...
                                  <div class="col-sm-4 col-lg-8 controls">
                                    <input data-validation="alphanumeric" data-validation-allowing="-" type="text" name="name" class="form-control add-stundt"  value="{{old('name')}}" placeholder="{{translation('enter_fee_name')}}"  data-rule-required="true" pattern="[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" />  

   ...
   <div class="box {{ $theme_color }}">
      <div class="box-title">
         ...
         <div class="box-tool">
            ...
            @endif              
            @if(array_key_exists('membership_plans.update', $arr_current_user_access))     
            ...
            @endif 
            @if(array_key_exists('membership_plans.delete', $arr_current_user_access))     
      ...
      <div class="box-content">
         ...
         <div class="table-responsive" style="border:0">
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     @if(array_key_exists('membership_plans.update', $arr_current_user_access) || array_key_exists('membership_plans.delete', $arr_current_user_access))
                     ...
                     @endif
                     <!--  <th>Sr no</th>  --> 
                     <th><a style="color:#333333;" href="#">{{translation('plan_name')}}</a>
                        
                     </th>

                     <th><a style="color:#333333;">{{translation('duration_type')}}</a>
                        
                     </th>
                     
                     <th><a style="color:#333333;"  href="#">{{translation('duration_value')}}</a>
                        
                     </th>

                     <th><a style="color:#333333;" href="#">{{translation('price')}} {{translation('mad')}}</a>
                        
                     </th>

                     <th><a style="color:#333333;" href="#">{{translation('stackholders')}}</a>
                     </th>

                     @if(array_key_exists('membership_plans.update', $arr_current_user_access) || array_key_exists('membership_plans.delete', $arr_current_user_access))
                      <th><a style="color:#333333;" href="#">{{translation('action')}}</a>       </th>
                     @endif
                  </tr>
               </thead>
            </table>
...
<script type="text/javascript">
   ...
   $(document).ready(function()
   {
     ...
     table_module = $('#table_module').DataTable({ 
       ...
       {data: 'plan_name', "orderable": false, "searchable":false},
       {
         render : function(data, type, row, meta) 
         {

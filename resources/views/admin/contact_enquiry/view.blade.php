          ...
          <div class="box-content view-details-seciton-main details-section-main-block">
            <div class="row">
                ...
                <div class="details-infor-section-block">
                  ...
                  <div class="form-group">
                     <label class="col-sm-4 col-lg-4 control-label"><b> {{translation('school_name')}}  </b>: </label>
                     <div class="col-sm-9 col-lg-4 controls">
                        {{ (isset($arr_contact_enquiry['get_school_admin']['school_admin']['school_id']) && $arr_contact_enquiry['get_school_admin']['school_admin']['school_id'] !="")  ?get_school_name($arr_contact_enquiry['get_school_admin']['school_admin']['school_id']):'-' }} 
                     </div>
                     <div class="clearfix"></div>
                  </div>

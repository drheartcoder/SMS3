                ...
                <div class="box-content">
                    ...
                    <div class="row" >
                      <div class="col-sm-12 col-lg-6">  
                                   {!! Form::open([ 'url' => $admin_panel_slug.'/payment_settings/update',
                                 'method'=>'POST',
                                 'id'=>'validation-form1',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               ...
                               <div class="radio-btns">
                                  <div class="radio-btn">
                                       <input type="radio" name="bank_status" id="enable" <?php if($arr_data['enable_wire_transfer']==1) {echo "checked";}  ?> value="1" >
                                       <label for="enable"> Enable</label>
                                      <div class="check"></div>
                                  </div>
                                  <div class="radio-btn">
                                    <input type="radio" id="no" name="bank_status" <?php if($arr_data['enable_wire_transfer']==0) {echo "checked";}  ?> value="0"> 
                            ...
                            <!--   <input type="radio" name="bank_status" <?php if($arr_data['enable_wire_transfer']==1) {echo "checked";}  ?> value="1" > Enable
                               <input type="radio" name="bank_status" <?php if($arr_data['enable_wire_transfer']==0) {echo "checked";}  ?> value="0"> Disable  -->
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               <input type="text" id="transfer_sort_order" name="transfer_sort_order" value="{{isset($arr_data['transfer_sort_order_of_display'])?$arr_data['transfer_sort_order_of_display']:''}}" class="form-control notAllowedZero" placeholder="Sort Order of Display" data-rule-required="true" data-rule-number="true" data-rule-maxlength="1" >
                               <span class='help-block sortErrorCls' id="error_transfer_sort_order" style="font-color:red!important;">{{ $errors->first('transfer_sort_order') }}</span>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                              <input type="text" name="account_name" value="{{isset($arr_data['account_name'])?$arr_data['account_name']:''}}" class="form-control" placeholder="Account Names" data-rule-required="true" pattern="^[a-zA-Z ]*$"> 
                    ...
                    <div class="col-sm-12 col-lg-6">  
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               ...
                               <div class="radio-btns">
                                  <div class="radio-btn">
                                       <input type="radio" name="payal_status" id="enable_paypal" <?php if($arr_data['enable_paypal']==1) {echo "checked";}  ?>  value="1" >
                                       <label for="enable_paypal"> Enable</label>
                                      <div class="check"></div>
                                  </div>
                                  <div class="radio-btn">
                                    <input type="radio" id="disable_paypal" name="payal_status" <?php if($arr_data['enable_paypal']==0) {echo "checked";}  ?> value="0"> 
                                      <label for="disable_paypal">Disable</label>
                                      <div class="check">
                                          <div class="inside"></div>
                                      </div>
                                  </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               ...
                               <span class='help-block sortErrorCls' id="error_paypal_sort_order" style="font-color:red!important;">{{ $errors->first('paypal_sort_order') }}</span>
                            </div>
                         </div>
                  ...
                  <div class="col-sm-12 col-lg-6">  
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                                <div class="radio-btns">
                                  <div class="radio-btn">
                                       <input type="radio" name="cheque_status" id="enable_cheque" <?php if($arr_data['enable_cheque_transfer']==1) {echo "checked";}  ?>   value="1" >
                                       <label for="enable_cheque"> Enable</label>
                                      <div class="check"></div>
                                  </div>
                                  <div class="radio-btn">
                                    <input type="radio" id="disable_cheque" name="cheque_status" <?php if($arr_data['enable_cheque_transfer']==0) {echo "checked";}  ?> value="0"> 
                                      <label for="disable_cheque">Disable</label>
                                      <div class="check">
                                          <div class="inside"></div>
                                      </div>
                                  </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               ...
                               <span class='help-block sortErrorCls' id="error_cheque_sort_order" style="font-color:red!important;">{{ $errors->first('cheque_sort_order') }}</span>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               <input type="text" name="payee_name" value="{{isset($arr_data['cheque_payee_name'])?$arr_data['cheque_payee_name']:''}}" class="form-control" pattern="^[a-zA-Z ]*$" placeholder="Cheque Payee Name" data-rule-required="true" >
                 ...
                 <div class="col-sm-12 col-lg-6">  
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               <div class="radio-btns">
                                  <div class="radio-btn">
                                       <input type="radio" name="cash_status" id="enable_cash" <?php if($arr_data['enable_cash_transfer']==1) {echo "checked";}  ?>   value="1" >
                                       <label for="enable_cash"> Enable</label>
                                      <div class="check"></div>
                                  </div>
                                  <div class="radio-btn">
                                    <input type="radio" id="disable_cash" name="cash_status"<?php if($arr_data['enable_cash_transfer']==0) {echo "checked";}  ?> value="0"> 
                                      <label for="disable_cash">Disable</label>
                                      <div class="check">
                                          <div class="inside"></div>
                                      </div>
                                  </div>
                              </div>
                              <span class='help-block'>{{ $errors->first('cash_status') }}</span>
                            </div>
                         </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                               ...
                               <span class='help-block sortErrorCls' id="error_cash_sort_order" style="font-color:red!important;">{{ $errors->first('cash_sort_order') }}</span>
                            </div>
                         </div>
                        <div class="form-group">
                            <div class="col-sm-3 col-sm-offset-6 col-lg-10 col-lg-offset-4">
...
/*     $(document).ready(function()
    ...
    {     
         $('.sortErrorCls').html('');
          ...
          {  
            $('#error_transfer_sort_order').html('Please enter positive numbers');
            $(this).val(''); 
          ...
          {  
              $('#error_transfer_sort_order').html('Sort order already exists for another payment setting ');  
              $(this).val('');
          }
    ...
    {     
         $('.sortErrorCls').html('');
          ...
          {  
            $('#error_paypal_sort_order').html('Please enter positive numbers');
            $(this).val(''); 
          ...
          {  
            ...
            $('#error_paypal_sort_order').html('Sort order already exists for another payment setting ');  
            //swal('Sort order already exists for another payment setting ');
            $(this).val('');
          }
    ...
    {     
         $('.sortErrorCls').html('');
          ...
          {  
            $('#error_cheque_sort_order').html('Please enter positive numbers');
            $(this).val(''); 
          ...
          {
            $('#error_cheque_sort_order').html('Sort order already exists for another payment setting ');  
    ...
    {     
         $('.sortErrorCls').html('');
          ...
          {  
            $('#error_cash_sort_order').html('Please enter positive numbers');
            $(this).val(''); 
          ...
          {
            $('#error_cash_sort_order').html('Sort order already exists for another payment setting ');  

                            ...
                            <form method="post" action="{{$module_url_path}}/update/{{base64_encode($arr_data['id'])}}"  class="form-horizontal" id="validation-form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            <input type="text" name="role" id="search-box" class="form-control" data-rule-required='true' placeholder="{{translation('role_name')}}" value="{{$arr_data['name']}}" @if($arr_data['is_approved']!="PENDING") @endif/>

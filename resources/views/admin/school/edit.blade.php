          ...
          <div class="box-title">
           ...
           <div class="box-content">
              ...
              <div class="tabbable">
                  ...
                  <form class="form-horizontal" onsubmit="return addLoader()"  name="validation-form1" id="validation-form1" method="POST" action="{{url('/admin')}}/school/update/{{$enc_id}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                            ...
                                            <div class="col-sm-5 col-lg-4 controls">
                                              ...
                                              @elseif($template['get_question_category']['slug'] == 'short')
                                                  ...
                                                  <input type="text" class="form-control" value="{{$value}}"
                                                      @if($template['id'] == 4)
                                                        name="school_name" pattern="^[a-zA-Z0-9 .&]+$"
                                              ...
                                              @elseif($template['get_question_category']['slug'] == 'browse_image')  
                                                    ...
                                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                                       <div class="fileupload-new img-thumbnail profile-img img" >
                                                          ...
                                                          @if(isset($value) && $value!='' && file_exists($base_url.$value))
                                                            <img src="{{$base_url.'/'.$value}}">
                                                          @else
                                                            <img src="{{url('images')}}/school-default-logo.png">
                                                          @endif
                                                       </div>
                 ...
                 <br/>
                    <div class="form-group">
                       <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                          <a href="{{ url($admin_panel_slug.'/school_admin') }}" class="btn btn-primary">{{translation('back')}}</a>                           

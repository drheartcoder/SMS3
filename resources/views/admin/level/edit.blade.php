                      ...
                      <div class="row">
                        <div class="form-group">
                                ...
                                <div class="col-sm-6 col-lg-8 controls">
                                        <input type="text" name="level" value="{{isset($arr_data['level_name'])?$arr_data['level_name']:''}}" class="form-control" data-rule-required='true' pattern="[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$"  placeholder="{{translation('enter_name')}}" >

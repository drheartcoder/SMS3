      ...
      <div class="col-md-12">
        ...
        <div class="box-content edit-space">
            ...
            @include('admin.layout._operation_status')  
                ...
                <form class="form-horizontal" onsubmit="return addLoader()" id="validation-form1" name="validation-form1" method="POST" action="{{ $module_url_path }}/store">
                  {{ csrf_field() }}
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="row">
                            ...
                            <label class="col-sm-3 col-lg-4 control-label" for="state"> 
                                {{translation('name')}} <i class="red"> *</i>
                            </label>
                            <div class="col-sm-6 col-lg-8 controls">
                                  <input type="text" name="level" value="{{old('level')}}" class="form-control" data-rule-required='true' pattern='^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$' placeholder="{{translation('enter_name')}}">
      ...
      $.ajax({
              ...
              success:function(data){
                //$('#chat-div').html(data.html);
                  ...
                  {
                    $('#err_level').show();
                    $('#err_level').text('This level is already exist');
                  }
              }
      });
    });

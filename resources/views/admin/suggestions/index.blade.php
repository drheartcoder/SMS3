        ...
        <table class="table table-advance" id="table_module">
            <thead>
                <tr>
                    ...
                    <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('from_school_number')}} </a><br />
                    </th>
                    <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('from_school_name')}} </a><br />
                    </th>
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        table_module = $('#table_module').DataTable({
            ...
            {data: 'school_no', "orderable": false, "searchable":false},
            {data: 'school_name', "orderable": false, "searchable":false},

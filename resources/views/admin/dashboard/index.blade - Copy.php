                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 manual-width-section">
                                <a class="ttl-express border-bottm-1" href="JavaScript:Void(0);">
                                    ...
                                    <span id="normal_rider_count" class="info-box-contentts">                                            
                                        <span class="name-tilt">User</span>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 manual-width-section">
                                <a class="ttl-express border-bottm-1" href="JavaScript:Void(0);">
                                    ...
                                    <span id="normal_rider_count" class="info-box-contentts">                                            
                                        <span class="name-tilt">My Profile</span>
                                        <span class="site-statistics-semi-content">
                                            Lorem ipsum
                                        </span>
                                    </span>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 manual-width-section">
                                <a class="ttl-express border-bottm-1" href="JavaScript:Void(0);">
                                    ...
                                    <span id="normal_rider_count" class="info-box-contentts">                                            
                                        <span class="name-tilt">Messages</span>
                                        <span class="site-statistics-semi-content">
                                            Lorem ipsum
                                        </span>
                                    </span>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 manual-width-section">
                                <a class="ttl-express border-bottm-1" href="JavaScript:Void(0);">
                                    ...
                                    <span id="normal_rider_count" class="info-box-contentts">                                            
                                        <span class="name-tilt">Sales Per Month</span>
                                        <span class="site-statistics-semi-content">
                                            Lorem ipsum
                                        </span>
                                    </span>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 manual-width-section">
                                <a class="ttl-express border-bottm-1" href="JavaScript:Void(0);">
                                    ...
                                    <span id="normal_rider_count" class="info-box-contentts">                                            
                                        <span class="name-tilt">Temporibus Tempora Molestias</span>
                                        <span class="site-statistics-semi-content">
                                            Lorem ipsum
                                        </span>
                                    </span>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 manual-width-section">
                                <a class="ttl-express border-bottm-1" href="JavaScript:Void(0);">
                                    ...
                                    <span id="normal_rider_count" class="info-box-contentts">                                            
                                        <span class="name-tilt">Lorem Ipsum Dolor</span>
                                        <span class="site-statistics-semi-content">
                                            Lorem ipsum
                                        </span>
                                    </span>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 manual-width-section">
                                <a class="ttl-express border-bottm-1" href="JavaScript:Void(0);">
                                    ...
                                    <span id="normal_rider_count" class="info-box-contentts">                                            
                                        <span class="name-tilt">Lorem Ongoing</span>
                                        <span class="site-statistics-semi-content">
                                            Lorem ipsum
                                        </span>
                                    </span>
            ...
            <div class="panel-bodys">
                ...
                <div class="progressDiv">
                    ...
                    <div class="statRightHolder">
                        <ul>
                            <li>
                                <h3 class="blue">39.4k</h3> <span>Interactions</span></li>
                            <li>
                                <h3 class="purple">1.8k</h3> <span>Posts</span></li>
                        </ul>

                        <ul class="statsLeft">
                            <li>
                                <h3 class="yellow">22%</h3> <span>Comments</span></li>
                            <li>
                                <h3 class="red">37%</h3> <span>Cheers</span></li>
                        </ul>
                        <ul class="statsRight">
                            <li>
                                <h3>18%</h3> <span>Tasks</span></li>
                            <li>
                                <h3>23%</h3> <span>Goals</span></li>
                        </ul>
                    </div>

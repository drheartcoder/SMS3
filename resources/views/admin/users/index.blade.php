...
<style type="text/css">
.users-table-main .table{margin-bottom: 15px !important;}
</style>
...
<div class="page-title new-agetitle">
    <div>
        <h1><i class="fa fa-users"></i> {{ isset($module_title)?$module_title:"" }}</h1>
    </div>
</div>
<!-- END Page Title -->
    ...
    <div class="col-md-12">
        <div class="box {{ $theme_color }}">
            ...
            <div class="box-content">
                ...
                <div class="table-responsive users-table-main" style="border:0">

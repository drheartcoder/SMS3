        ...
        <div class="box {{ $theme_color }}">
            <div class="box-title">
                ...
                <div class="box-tool">
                    ...
                    @if(array_key_exists('school_admin.update', $arr_current_user_access))     
                    ...
                    @if(array_key_exists('school_admin.delete', $arr_current_user_access))     
                    ...
                    @endif
                    <a title="{{translation('refresh')}}" href="{{ $module_url_path }}" style="text-decoration:none;">
            ...
            <div class="box-content">
                ...
                <div class="table-responsive" style="border:0">
                    ...
                    <table class="table table-advance"  id="table_module">
                        <thead>
                            <tr>
                                @if(array_key_exists('school_admin.update', $arr_current_user_access) || array_key_exists('school_admin.delete', $arr_current_user_access))                             
                                ...
                                @endif
                                <!--  <th>Sr no</th>  --> 
                                <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('name')}} </a>
                                </th>
                                <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('email')}} </a>
                                </th>
                                <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('school_name')}} </a></th>
                                <th></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        table_module = $('#table_module').DataTable({
            ...
            {data: 'school_name', "orderable": true, "searchable":false},

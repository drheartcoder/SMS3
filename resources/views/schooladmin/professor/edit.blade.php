                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                          <input type="text" name="first_name" class="form-control" data-rule-required='true' data-rule-pattern="^[a-zA-Z àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" data-rule-maxlength='255' placeholder="{{translation('enter_first_name')}}" value="{{$arr_data['get_user_details']['first_name']}}">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                          <input type="text" name="last_name" class="form-control" data-rule-required='true' data-rule-pattern="^[a-zA-Z àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" data-rule-maxlength='255' placeholder="{{translation('enter_last_name')}}" value="{{$arr_data['get_user_details']['last_name']}}">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">                
                                             ...
                                             <div class="frmSearch relative-block">
                                               <input type="text" name="country" id="country" class="form-control" data-rule-required='true' placeholder="{{translation('enter_country')}}" value="{{$arr_data['get_user_details']['country']}}"  autocomplete="off"/>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">                              
                                             <div class="frmSearch relative-block">
                                               <input type="text" name="city" id="locality" class="form-control" data-rule-required='true' placeholder="{{translation('enter_city')}}" value="{{$arr_data['get_user_details']['city']}}" autocomplete="off"/>
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <input type="text" name="national_id" id="national_id" data-rule-required="true" class="form-control" value="{{$arr_data['get_user_details']['national_id']}}" pattern="[a-zA-Z0-9àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" placeholder="{{translation('enter_national_id')}}"/>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">    
                                             <select class="form-control" name="status">
                                                <option value="" selected> {{translation('select')}} {{translation('status')}}</option>
                                                <option value="MARRIED" @if($arr_data['status'] == 'MARRIED') selected @endif> {{translation('married')}}</option>
                                                <option value="SINGLE" @if($arr_data['status'] == 'SINGLE') selected @endif> {{translation('single')}}</option>
                                                <option value="ENGAGED" @if($arr_data['status'] == 'ENGAGED') selected @endif> {{translation('engaged')}}</option>
                                                <option value="DIVORCED" @if($arr_data['status'] == 'DIVORCED') selected @endif> {{translation('divorced')}}</option>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <input type="text" name="year_of_experience"  id="year_of_experience" class="form-control" data-rule-required='true' data-rule-number="true" placeholder="{{translation('enter_year_of_experience')}}" data-rule-maxlength="5"  max="50" value="{{$arr_data['year_of_experience']}}" >
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <input type="text" name="qualification_degree"  id="qualification_degree" class="form-control" data-rule-required='true' value="{{$arr_data['qualification_degree']}}"  pattern="[a-zA-Z0-9, àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" placeholder="{{translation('enter_qualificationdegree')}}">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <select class="js-example-basic-multiple form-control" multiple="multiple" name="subject[]" data-rule-required='true'>
                                               @foreach($course as $key => $value)
                                                  ...
                                                  <option value="{{$value['get_course']['id']}}"  @if(in_array($value['get_course']['id'],$id)) selected="selected" @endif>{{$value['get_course']['course_name']}} </option>
                                               @endforeach
                                             </select>
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <select class="js-example-basic-multiple form-control" multiple="multiple" name="levels[]" data-rule-required='true'>
                                               @foreach($arr_level as $key => $value)
                                                  ...
                                                  <option value="{{$value['level_id']}}"  @if(isset($level_id) && count($level_id)>0 &&  in_array($value['level_id'],$level_id)) selected="selected" @endif>{{$value['level_details']['level_name']}} </option>
                                               @endforeach
                                             </select>

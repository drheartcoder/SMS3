                    ...
                    <div class="row">
                        <div class="col-md-4 user-details">
                            <div class="user-details-section-main">
                                ...
                                <div class="form-group">
                                     <label class="control-label"><b> {{translation('staff_id')}} </b>: </label>
                                     <div class="controls">
                                        {{$no}}
                                     </div>
                                     <div class="clearfix"></div>
                        ...
                        <div class="col-md-4">
                            <div class="user-details-section-main">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="controls">
                                      {{translation(strtolower($marital_status))}}
                                   </div>
                                   <div class="clearfix"></div>
                                </div>

   ...
   <div class="col-md-12">
      <div class="box box-navy_blue">
         ...
         <div class="box-content">
            ...
            <div class="tobbable">
               <form method="post" onsubmit="return addLoader()"  action="{{$module_url_path}}/store"  class="form-horizontal professor-create-form" id="validation-form1" enctype ='multipart/form-data'>
                  {{ csrf_field() }}
                        <br>
                        <div class="row">
                           <div class="col-sm-12 col-md-12 col-lg-6">
                              <div class="row">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">                
                                       <input type="text" name="email"  id="email" class="form-control form-cascade-control" data-rule-required='true'  data-rule-email="true" value="{{old('email')}}" placeholder="{{translation('enter_email')}}">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                       <input type="text" name="first_name" class="form-control form-cascade-control" data-rule-required='true' data-rule-pattern="^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" data-rule-maxlength='255' placeholder="{{translation('enter_first_name')}}">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                       <input type="text" name="last_name" class="form-control form-cascade-control" data-rule-required='true' data-rule-pattern="^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" data-rule-maxlength='255' placeholder="{{translation('enter_last_name')}}">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">                
                                       ...
                                       <input type="text" name="address" id="location" data-rule-required='true'  class="form-control" placeholder="{{translation('enter_location')}}"  />
                              ...
                              <div class="row">
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">                
                                       <input type="text" name="national_id" id="national_id" data-rule-required='true'  class="form-control" value="{{old('national_id')}}" placeholder="{{translation('enter_national_id')}}" pattern="[a-zA-Z0-9\-àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$"/>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">                
                                       <input type="text" name="birth_date"  style="cursor: pointer" id="datepicker" class="form-control datepikr" data-rule-required='true' data-rule-date="true" value="{{old('birth_date')}}" placeholder="{{translation('enter_birth_date')}}" readonly>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                       <div class="radio-btns">
                                          <div class="radio-btn">
                                             <input type="radio" id="f-option" name="gender" value="MALE" checked @if(old('gender') == 'MALE') checked @endif checked>
                                             <label for="f-option">{{translation('male')}}</label>
                                             <div class="check"></div>
                                          </div>
                                          <div class="radio-btn">
                                             <input type="radio" id="s-option" name="gender" value="FEMALE" @if(old('gender') == 'FEMALE') checked @endif>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                       <select class="form-control" name="status">
                                          ...
                                          <option value="MARRIED" @if(old('status') == 'MARRIED') selected @endif> {{translation('married')}}</option>
                                          <option value="SINGLE" @if(old('status') == 'SINGLE') selected @endif> {{translation('single')}}</option>
                                          <option value="ENGAGED" @if(old('status') == 'ENGAGED') selected @endif> {{translation('engaged')}}</option>
                                          <option value="DIVORCED" @if(old('status') == 'DIVORCED') selected @endif> {{translation('divorced')}}</option>
                                       </select>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">                
                                       <input type="text" name="year_of_experience"  id="year_of_experience" class="form-control form-cascade-control" data-rule-required='true' data-rule-number="true" data-rule-maxlength="5"  max="50" value="{{old('year_of_experience')}}" placeholder="{{translation('enter_year_of_experience')}}">
                                       <span for="year_of_experience" class="help-block">{{ $errors->first('year_of_experience') }}</span>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">                
                                       <input type="text" name="qualification_degree" pattern="^[a-zA-Z0-9 ,]*$" id="qualification_degree" class="form-control form-cascade-control" data-rule-required='true' value="{{old('qualification_degree')}}" placeholder="{{translation('enter_qualificationdegree')}}">
                                       <span class="help-block">{{ $errors->first('qualification_degree') }}</span>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-4 col-lg-4 control-label">{{translation('subject')}}
                                    <i class="red">*</i>
                                    </label>
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">      
                                       <select data-rule-required='true' class="js-example-basic-multiple form-control" multiple="multiple" name="subject[]" id="subject" placeholder= "{{translation('select_course')}}">
                                       ...
                                       <span for="subject" class="help-block">{{ $errors->first('subject') }}</span>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="col-xs-12 col-sm-4 col-md-4 col-lg-4 control-label">{{translation('level')}}
                                    <i class="red">*</i>
                                    </label>
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                       <select data-rule-required='true' class="js-example-basic-multiple form-control" multiple="multiple" name="levels[]" id="levels" placeholder= "{{translation('select_level')}}">
                                       @foreach($arr_level as $key => $value)
                                       <option value="{{$value['level_id']}}" @if(old('subject') == $value['level_id']) selected @endif>{{$value['level_details']['level_name'] or ''}}</option>
                                       @endforeach
                                       </select>
                                       <span for="levels" class="help-block">{{ $errors->first('levels') }}</span>
                                    </div>
                                 </div>
                ...
                if(data.status=='parent')
                  {
                     ...
                     if(data.details){
                        ...
                        $('input[name="first_name"]').val(values.first_name);
                        $('input[name="last_name"]').val(values.last_name);
                        $('input[name="address"]').val(values.address);
                        $('input[name="city"]').val(values.city);
                        $('input[name="country"]').val(values.country);
                        $('input[name="national_id"]').val(values.national_id);
                        $('input[name="birth_date"]').val(values.birth_date);
                        $("#f-option").removeAttr('checked');
                        ...
                        $('input[name="year_of_experience"]').val(values.year_of_experience);
                        $('input[name="mobile_no"]').val(values.mobile_no);
                        $('input[name="telephone_no"]').val(values.telephone_no);
                        $('input[name="qualification_degree"]').val(values.qualification_degree);

                        $("select[name='status'] option[value="+values.status+"]").attr("selected","selected");
                     ...
                     $('input[name="year_of_experience"]').val('');
                     $('input[name="mobile_no"]').val('');
                     $('input[name="telephone_no"]').val('');
                     $('input[name="qualification_degree"]').val('');

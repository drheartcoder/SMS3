...
<div class="col-md-12">
   <div class="box {{ $theme_color }}">
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('stock_distribution')}}</a> 
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('user_role')}} </a><br /> 
                     </th>
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('user_name')}} </a><br />
                     </th>
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('distributed_stock')}} </a><br />
                     </th>
                      <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('distribution_date')}} </a><br />
                     </th>
...
@if(array_key_exists('stocks.list', $arr_current_user_access))  
 <script type="text/javascript">
      ...
      /*Script to show table data*/
          ...
          {data: 'quantity_distributed', "orderable": false, "searchable":false},

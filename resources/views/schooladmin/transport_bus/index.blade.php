...
<div class="col-md-12">
   <div class="box {{ $theme_color }}">
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            ...
            <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('bus')}}</a> 
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     <th><a  href="#" class="sort-descs" style="color:#dedede;">{{translation('bus_driver_name')}} </a></th>
                     <th><a  href="#" class="sort-descs" style="color:#dedede;">{{translation('bus_capacity')}} </a></th>
                     @if(array_key_exists('transport_bus.update', $arr_current_user_access)) 
                     <th><a  href="#" class="sort-descs" style="color:#dedede;">{{translation('add').' '.translation('student')}} </a></th>
                     @endif
                     ...
                     <th><a  href="#" class="sort-descs" style="color:#dedede;">{{translation('action')}}</a></th>
                     @endif
                  </tr>
               </thead>
            </table>
 ...
 <script type="text/javascript">
      ...
      /*Script to show table data*/
          ...
          {data: 'bus_driver_name', "orderable": false, "searchable":false},
          {data: 'bus_capacity', "orderable": false, "searchable":false},
          @if(array_key_exists('transport_bus.update', $arr_current_user_access)) 
          {  
            render : function(data, type, row, meta) 
            {
              return row.build_add_student;
            },
            "orderable": false, "searchable":false
          },
          @endif

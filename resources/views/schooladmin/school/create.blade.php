        ...
        <div class="box {{ $theme_color }}">
          <div class="box-title">
           ...
           <div class="box-content edit-btns">
              <a href="javascript:void(0)" class="edit-btn-profile">
              ...
              <?php $count=0; ?>
                 ...
                 <div class="tabbable">
                  ...
                  <form class="form-horizontal" name="validation-form1" id="validation-form1" method="POST" action="{{$module_url_path}}/store" enctype="multipart/form-data" onsubmit="return addLoader()">
                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5 col-lg-4 controls">
                                              ...
                                              @elseif($template['get_question_category']['slug'] == 'latitude')
                                                 <input type="text" name="{{strslug($label)}}" id="latitude" class="form-control" value="{{old(strslug($label))}}" placeholder="{{$label}}" 
                                                  @if($template['is_required']==1)
                                                    data-rule-required="true"
                                                  @endif
                                              ...
                                              @elseif($template['get_question_category']['slug'] == 'longitude')
                                                 <input type="text" name="{{strslug($label)}}" id="longitude" class="form-control" value="{{old(strslug($label))}}" placeholder="{{$label}}"
                                                  @if($template['is_required']==1)
                                                    data-rule-required="true"
                                                  @endif  
                    ...
                    <div class="form-group">
                       <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                          <a href="{{ url($school_admin_panel_slug.'/school_admin') }}" class="btn">{{translation('back')}}</a> 

    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-tool">
            @if(array_key_exists('course.create', $arr_current_user_access))  
            <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('course')}}</a>
            @endif 
            ...
            <table class="table table-advance"  id="table_module" >
              <thead>
                <tr>
                  ...
                  @endif
                  <th>
                    {{translation('school_level_class_name')}}
                  </th>
                  <th>
 ...
 <script type="text/javascript">
          ...
          $(document).ready(function()
          {
            table_module = $('#table_module').DataTable({
              ...
              'data': function(d)
                {
                  d['column_filter[q_exam_type]']          = $("input[name='q_exam_type']").val()
                }
              },
           columns: [
           @if(array_key_exists('course.update', $arr_current_user_access) || array_key_exists('course.delete', $arr_current_user_access) )
          ...
          {data: 'coefficient', "orderable": false, "searchable":false}
          @if(array_key_exists('course.update', $arr_current_user_access) || array_key_exists('course.delete', $arr_current_user_access) )
          ,
          {
            render : function(data, type, row, meta) 

      ...
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            @if(array_key_exists('canteen.create', $arr_current_user_access))  
              <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('canteen_product')}}</a> 
            @endif
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('product_price')}} </a><br />
                     </th>
      ...
      /*Script to show table data*/
          ...
          $(document).ready(function()
          {
            table_module = $('#table_module').DataTable({
              ...
              ordering:false,
              ajax: {
              'url':'{{ $module_url_path.'/get_products'}}',
              'data': function(d)
                {
          ...
          {data: 'product_type', "orderable": false, "searchable":false},
          ...
          {data: 'product_price', "orderable": false, "searchable":false},
          {
            render : function(data, type, row, meta) 
            {

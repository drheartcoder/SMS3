            ...
            <form method="post" onsubmit="return addLoader()"  enctype="multipart/form-data"  action="{{$module_url_path}}/store"  class="form-horizontal" id="validation-form1">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-4 controls">
                        ...
                        <option value="complement">{{translation('complement')}}</option>
                        <option value="warning">{{translation('warning')}}</option>   
                        </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-4 controls">
                       <textarea class="form-control" type="text" name="default_value1" "></textarea>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-4 controls">
                       <textarea class="form-control" type="text" name="default_value2" ></textarea>
                 ...
                 <div id="complement">
                   <div class="form-group">
                      ...
                      <div class="col-sm-8 col-md-8 col-lg-4 controls">
                         <textarea class="form-control" type="text" name="default_value3"></textarea>

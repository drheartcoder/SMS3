      ...
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            @if(array_key_exists('news.create',$arr_current_user_access))
              <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('news')}}</a> 
            @endif
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     @endif
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('news')}} {{translation('image')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('news')}} {{translation('title')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('publish_date')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('created_at')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('is_publish')}} </a></th>
      ...
      /*Script to show table data*/
          ...
          @if(array_key_exists('news.delete', $arr_current_user_access))    
           ...
           @endif
           {
            render : function(data, type, row, meta) 
            {
              return row.news_image;
            },
            "orderable": false, "searchable":false
          },
          {data: 'news_title', "orderable": false, "searchable":false},
          {data: 'publish_date', "orderable": false, "searchable":false},
          
          {data: 'created_at', "orderable": false, "searchable":false},
          {data: 'is_live', "orderable": false, "searchable":false}
         @if(array_key_exists('room_assignment.update', $arr_current_user_access) || array_key_exists('news.delete', $arr_current_user_access)),
          {
            render : function(data, type, row, meta) 
            {

                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="user-details-section-main">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                     <label class="control-label"><b> {{translation('position')}} </b>: </label>
                                     <div class="controls">
                                        <?php
                                        $position =explode('_', $role);?>
                                        {{ucfirst($position[1])}}
                                     </div>
                                     <div class="clearfix"></div>
                                  </div>
                       ...
                       <div class="col-md-12">
                            <div class="form-group back-btn-form-block">
                               <div class="controls">
                                  <a href="{{ $module_url_path }}" class="btn btn-primary" style="float: right;" > <i class="fa fa-arrow-left"></i> Back </a>
                               </div>
                            </div>
                      </div>                       
                    </div>                    

            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box  box-navy_blue">
                        <div class="box-title">
                            <h3><i class="fa {{$edit_icon}}"></i>{{translation('edit')}} {{translation('stock')}}</h3>
                            <div class="box-tool">
                            </div>
                        </div>
                            ...
                            <form method="POST" action="{{$module_url_path}}/update/{{$enc_id}}" accept-charset="UTF-8" class="form-horizontal" id="validation-form1" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-lg-4 controls">
                                        <input class="form-control" name="product_id" id="product_id" placeholder="{{translation('enter')}} {{translation('product_id')}}" type="text" data-rule-required="true" pattern="^[a-zA-ZàâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ0-9 ]+$" value="{{isset($arr_stock['product_id'])?$arr_stock['product_id']:'-'}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-lg-4 controls">
                                        <input class="form-control" name="quantity" id="quantity" placeholder="{{translation('enter')}} {{translation('quantity')}}" type="text" data-rule-required="true"  onKeyUp="totalValue();" data-rule-digits="true" data-rule-min="0"  value="{{isset($arr_stock['quantity'])?$arr_stock['quantity']:'-'}}" readonly style="cursor: pointer">
                                    </div>
                                </div>                                        

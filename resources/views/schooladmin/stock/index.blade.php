...
<div class="col-md-12">
   <div class="box {{ $theme_color }}">
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            @if(array_key_exists('stocks.create', $arr_current_user_access))
              <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('stock')}}</a>
            @endif   
            @if(array_key_exists('stocks.delete', $arr_current_user_access))     
               <a title="{{translation('multiple_delete')}}" 
                  href="javascript:void(0);" 
                  onclick='javascript : return check_multi_action("frm_manage","{{translation('are_you_sure')}}","{{translation('once_you_delete_record_all_distribution_details_will_also_get_deleted').'?'}}","{{translation('yes')}}","{{translation('no')}}","{{translation('oops')}}","{{translation('please_select_the_record_to_perform_this_action')}}","delete");'
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('total_price')}} (MAD)</a><br />
                     </th>
                      <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('date_created')}} </a><br />
                     </th>

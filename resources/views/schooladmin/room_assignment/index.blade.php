      ...
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            @if(array_key_exists('room_assignment.create',$arr_current_user_access))     
              <a href="{{$module_url_path}}/create" >{{translation('assign_room')}}</a> 
            @endif
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     @endif
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('tag')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('floor_no')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('room_name')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('room_number')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('assign_level')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('assign_class')}} </a></th>
                     @if(array_key_exists('room_assignment.update', $arr_current_user_access) || array_key_exists('room_assignment.delete', $arr_current_user_access))     
 ...
 <script type="text/javascript">
      ...
      /*Script to show table data*/
          ...
          @if(array_key_exists('room_assignment.delete', $arr_current_user_access))    
           ...
           @endif
          {data: 'tag_name', "orderable": false, "searchable":false},
          {data: 'floor_no', "orderable": false, "searchable":false},
          {data: 'room_name', "orderable": false, "searchable":false},

          {data: 'room_no', "orderable": false, "searchable":false},
          {data: 'level_name', "orderable": false, "searchable":false},
          {data: 'class_name', "orderable": false, "searchable":false}
          @if(array_key_exists('room_assignment.delete', $arr_current_user_access)||array_key_exists('room_assignment.update', $arr_current_user_access)),
          {
            render : function(data, type, row, meta) 
            {

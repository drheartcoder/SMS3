                           ...
                           @include('schooladmin.layout._operation_status')
                            <form method="post" onsubmit="return addLoader()"  action="{{$module_url_path}}/update/{{$enc_id}}"  class="form-horizontal" id="validation-form1">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            ...
                                            @if(!empty($arr_room_data) && count($arr_room_data) > 0)
                                                ...
                                                <option @if($val['id']==@$arr_data['room_management_id'])  selected="selected" @endif value="{{ $val['id'] }}" data-tag-name="{{$val['tag_name']}}"  >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            <select  class="form-control" name="floor_no" id="floor_no" data-rule-required="true"   >
                                            <option value="">{{ translation('select') }} {{translation('floor_no')}}</option>   
                                             @if(!empty($resTags) && count($resTags) > 0)
                                                @foreach($resTags as $val)
                                                <option value="{{ $val['id'] }}" data-total-rooms="{{$val['no_of_rooms']}}" @if($val['id']==$arr_data['room_management_id'])  selected="selected" @endif >
                                                    {{ $val['floor_no'] }}
                                                </option>    
                                                @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            <input type="text" name="room_name" id="room_name" class="form-control"   data-rule-required='true' maxlength="100" placeholder="{{translation('enter')}} {{translation('room_name')}}" value="{{ $arr_data['room_name'] or '' }}" />
                                            <div id="suggesstion-box"></div>
                                          </div>
                                        <span class="help-block"></span>
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                              <select  class="form-control" name="room_number" id="room_number" data-rule-required="true" >
                                              <option value="">{{ translation('select') }} {{translation('room_number')}}</option>   

                                              @if(isset($arr_data['get_room_management']['no_of_rooms']) && $arr_data['get_room_management']['no_of_rooms']>0)
                                              <?php for($i=1;$i<=$arr_data['get_room_management']['no_of_rooms'];$i++){ ?>
                                              <option value="{{$i}}" @if($i==$arr_data['room_no']) selected="selected" @endif>{{$i}}</option>
                                              <?php } ?>
                                              @endif
                                ...
                                <?php
                                  ...
                                  $selectedLevle = isset($arr_data['get_level_class']['level_id'])?$arr_data['get_level_class']['level_id']:'';
                                  $selectedCls = isset($arr_data['get_level_class']['class_id'])?$arr_data['get_level_class']['class_id']:'';
                                ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            ...
                                            @if(!empty($arr_level) && count($arr_level) > 0)
                                                ...
                                                <option value="{{ $val['level_id'] }}" @if($val['level_id']==$selectedLevle) selected="selected" @endif  >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                             <select  class="form-control" name="assign_class" id="assign_class" data-rule-required="true" >
                                            <option value="">{{ translation('select') }} {{translation('class')}}</option>   
                                            @if(!empty($arr_class) && count($arr_class) > 0)
                                                @foreach($arr_class as $val)
                                                <option value="{{ $val['class_id'] }}" @if($val['class_id']==$selectedCls) selected="selected" @endif  >
                                                    {{ ucwords($val['get_class']['class_name']) }}
                                                </option>    
                                                @endforeach
                                            @endif
                                            </select>

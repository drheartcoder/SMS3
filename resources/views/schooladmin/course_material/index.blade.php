          ...
          <table class="table table-advance"  id="table_module" >
            ...
            <tbody>
              ...
              <tr>
                ...
                <?php 
                  $first_name = isset($course_data['user_details']['first_name'])?ucwords($course_data['user_details']['first_name']):'';
                  $last_name = isset($course_data['user_details']['last_name'])?ucwords($course_data['user_details']['last_name']):'';

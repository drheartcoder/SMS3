...
<div class="col-md-12">
   <div class="box {{ $theme_color }}">
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            @if(array_key_exists('professor_replacement.create',$arr_current_user_access))     
              <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('professor_replacement')}}</a> 
            @endif  
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     @endif
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('professor_name')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('professor_no')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('from_date')}} </a></th>
                     <th><a  class="sort-descs" href="#" style="color:#dedede;">{{translation('to_date')}} </a></th>
 ...
 <script type="text/javascript">
      ...
      /*Script to show table data*/
          ...
          {data: 'professor_no', "orderable": false, "searchable":false},
          {data: 'from_date', "orderable": false, "searchable":false},
          {data: 'to_date', "orderable": false, "searchable":false},
          @if(array_key_exists('professor_replacement.update', $arr_current_user_access) || array_key_exists('professor_replacement.delete', $arr_current_user_access))
          {
            render : function(data, type, row, meta) 
            {

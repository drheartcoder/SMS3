    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-tool">
             @if(array_key_exists('exam_type.create', $arr_current_user_access))  
            <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('exam_type')}}</a> 
            @endif

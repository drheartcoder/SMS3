      ...
      <div class="box-title pr0">
         ...
         <div class="box-tool">
          @if(array_key_exists('canteen.create', $arr_current_user_access))  
            <a href="{{$module_url_path}}/add_canteen_staff" >{{translation('add')}} {{translation('canteen_staff')}}</a> 
          @endif  
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('staff_number')}} </a><br />

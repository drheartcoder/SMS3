                              ...
                              <div class="row">
                                 <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                          <input type="text" name="first_name" class="form-control" data-rule-required='true' data-rule-pattern="^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" data-rule-maxlength='255' value="{{old('first_name')}}" placeholder="{{translation('enter_first_name')}}">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                                          <input type="text" name="last_name" class="form-control" data-rule-required='true' data-rule-pattern="^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" data-rule-maxlength='255' value="{{old('last_name')}}" placeholder="{{translation('enter_last_name')}}">
                                 ...
                                 <div class="col-sm-12 col-md-12 col-lg-6">
                                    <div class="row">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <input type="text" name="national_id" id="national_id" data-rule-required='true'  class="form-control" value="{{old('national_id')}}" placeholder="{{translation('enter_national_id')}}" pattern="^[A-Za-z0-9]*$"/>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <input type="text" name="birth_date"  id="datepicker" class="form-control datepikr" data-rule-required='true' value="{{old('birth_date')}}" placeholder="{{translation('enter_birth_date')}}" data-rule-date="true" readonly style="cursor: pointer;">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">    
                                             ...
                                             <select class="form-control" name="status">
                                                ...
                                                <option value="SINGLE" @if(old('status') == 'SINGLE') selected @endif> Single</option>
                                                <option value="ENGAGED" @if(old('status') == 'ENGAGED') selected @endif> Engaged</option>
                                                <option value="DIVORCED" @if(old('status') == 'DIVORCED') selected @endif> Divorced</option>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <input type="text" name="year_of_experience"  id="year_of_experience" class="form-control" data-rule-required='true' value="{{old('year_of_experience')}}" placeholder="{{translation('enter_year_of_experience')}}"  data-msg-maxlength="{{translation('year_of_experience_can_not_be_greater_than_2_digits')}}" data-rule-maxlength="2">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">        
                                             <input type="text" name="qualification_degree" id="qualification_degree" class="form-control" data-rule-required='true' value="{{old('qualification_degree')}}" pattern="^[a-zA-Z0-9 ,]*$" placeholder="{{translation('enter_qualificationdegree')}}">

       ...
       <form method="post" onsubmit="return addLoader()" action="{{$module_url_path}}/store"  class="form-horizontal" id="validation-form1">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
            <input type="text" class="form-control" name="club_name" id="club_name" data-rule-required='true' data-rule-pattern="^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" placeholder="{{translation('enter').' '. strtolower(translation('club_name'))}}"/>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
            <input type="text" class="form-control" name="club_id" id="club_id" data-rule-required='true' pattern="^[a-zA-Z0-9 ]+$" placeholder="{{translation('enter').' '. strtolower(translation('club_id'))}}"/>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">  
            <div class="radio-btns">  
              <div class="radio-btn">
                <input type="radio" id="paid" name="club_type" value="paid" checked>
                <label for="paid">{{translation('paid')}}</label>
                <div class="check"></div>
              </div>
              <div class="radio-btn">
                <input type="radio" id="free" name="club_type" value="free">
        ...
        <div class="form-group club_fee">
          ...
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
            <input type="text" class="form-control" name="club_fees" id="club_fees" data-rule-required='true' data-rule-number="true" placeholder="{{translation('enter').' '. strtolower(translation('club_fees'))}}" data-rule-min="0"/>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
            <textarea class="form-control" name="description" id="description" data-rule-required='true' placeholder="{{translation('enter').' '. strtolower(translation('description'))}}"></textarea>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
            <input type="text" class="form-control" name="club_place" id="club_place" data-rule-required='true' placeholder="{{translation('enter').' '. strtolower(translation('place'))}}"/>

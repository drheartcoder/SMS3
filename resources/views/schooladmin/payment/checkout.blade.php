...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li>
            <i class="fa fa-home"></i>
            <a href="{{ url(config('app.project.school_admin_panel_slug'))}}/student">{{translation('student')}}</a>
        </li>
        <span class="divider">
            <i class="fa fa-angle-right"></i>
        </span>
        <li> 
          ...
          @if(\Session::has('student_id'))
            <a href="{{$module_url_path.'/'.base64_encode(\Session::get('student_primary_key'))}}">{{translation('payment')}}</a>
          @else
            <a href="{{url(config('app.project.school_admin_panel_slug'))}}/student">{{translation('payment')}}</a>  
          @endif
        </li>
        <span class="divider">
            <i class="fa fa-angle-right"></i>
        ...
        <li> 
          <i class="{{$module_icon}}"></i>
          <a class="active">{{translation('checkout')}}</a>
        </li>
...
-->
                                            ...
                                            <div class="clearfix"></div>
                                               @if(array_key_exists('payment.update', $arr_current_user_access) || array_key_exists('payment.delete', $arr_current_user_access))

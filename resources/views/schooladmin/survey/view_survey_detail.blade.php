...
<div class="col-md-12">
   <div class="box box-navy_blue">
        <div class="box-title">
            <h3><i class="fa fa-eye"></i>{{translation('details')}}</h3>
            <div class="box-tool">
            </div>
        </div> 
         <div class="box-content">            
                ...
                <div class="form-group img-view-pro">
                    ...
                    <div class="col-sm-9 col-md-8 col-lg-7 col-lg-offset-3 controls">
                       <form method="POST" action="{{ $module_url_path }}" accept-charset="UTF-8" class="form-horizontal"  enctype="multipart/form-data"  id="validation-form1" >
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="col-sm-8 col-sm-offset-4 col-lg-9 col-lg-offset-3">
                      <a href="{{ url('/') }}/{{ config('app.project.school_admin_panel_slug') }}/survey/view_response/{{ $enc_survey_id }}" class="btn btn-primary" style="float: right;margin-top: 20px;" > <i class="fa fa-arrow-left"></i> {{translation('back')}} </a>
                </div>

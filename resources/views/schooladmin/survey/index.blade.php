...
<div class="col-md-12">
   <div class="box {{ $theme_color }}">
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            @if(array_key_exists('survey.create',$arr_current_user_access))     
            <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('survey')}}</a> 
            @endif
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     <th><a  class="sort-descs" href="#" >{{translation('survey_for')}} </a></th>

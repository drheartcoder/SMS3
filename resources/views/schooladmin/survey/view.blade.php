                                        ...
                                        <div class="panel-body">
                                           <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="sb-titl-pro-surv question-type-section">
                                                    <div class="left-fessor-vw-left">{{translation('question_type')}} : </div>
                                                    <div class="left-fessor-vw-right"> {{ $arr_dataRs['get_question_type']['name'] or '' }} </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="sb-titl-pro-surv ques-options-section">
                                                    ...
                                                    <div class="left-fessor-vw-right">{{ $value }} </div>
                                                </div>
                                            </div>
                                            <?php } } ?>

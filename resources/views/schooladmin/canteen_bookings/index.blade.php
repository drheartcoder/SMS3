                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 controls">
                          <div class="assignment-gray-main">
                            <select class="form-control column_filter" name="q_user" data-rule-required='true' id="user_type" onChange="filterData();">
                            ...
                            <span id="err_level" style="display: none; color: red"></span>
                        </div>
                        </div>
                    </div>
                  </div>
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     @endif
                     <!--  <th>Sr no</th>  --> 
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('order_no')}} </a><br />
                     ...
                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('total_amount')}} (MAD) </a><br />

                     </th>

                     <th><a class="sort-descs" href="#" style="color:#dedede;">{{translation('order_type')}}</a><br />
      ...
      /*Script to show table data*/
          ...
          $(document).ready(function()
          {
            table_module = $('#table_module').DataTable({
              ...
              'data': function(d)
                {
                  d['column_filter[q_user]']       = $("select[name='q_user']").val()
                }
              },
           columns: [
           @if(array_key_exists('canteen_bookings.delete', $arr_current_user_access))                             
          ...
          {data: 'order_type', "orderable": false, "searchable":false},
            {
              render : function(data, type, row, meta) 
              {

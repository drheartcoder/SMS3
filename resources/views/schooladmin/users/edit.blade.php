        ...
        <div class="box-content">
          ...
          <div class="tabbable">
                ...
                <ul  class="nav nav-tabs">
                   @include('schooladmin.layout._multi_lang_tab')
                </ul>
                ...
                <div  class="tab-content">
                  ...
                  @if(isset($arr_lang) && sizeof($arr_lang)>0)
                    @foreach($arr_lang as $lang_key => $lang)
                      ...
                      <div class="tab-pane fade {{ $key==0?'in active':'' }}"  id="{{ $lang['locale'] }}">
                            ...
                            @endif
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-4 col-lg-4 controls">
                                    <input type="text" name="first_name_{{$lang['locale']}}" data-rule-pattern="^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" data-rule-required='true' class="form-control" value="{{$arr_data['user_details'][$lang_key]['first_name']}}" />
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-4 col-lg-4 controls">        
                                    <input type="text" name="last_name_{{$lang['locale']}}" class="form-control"  value="{{$arr_data['user_details'][$lang_key]['last_name']}}"  data-rule-required="true" data-rule-pattern="^[a-zA-Z0-9 àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$"/>  

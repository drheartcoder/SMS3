      ...
      <div class="box-title pr0">
         ...
         <div class="box-tool">
            @if(array_key_exists('brotherhood.create', $arr_current_user_access))
              <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('brotherhood')}}</a> 
            @endif
            ...
            <table class="table table-advance"  id="table_module">
               <thead>
                  <tr>
                     ...
                     @endif
                     <th><a  href="#" class="sort-descs" style="color:#dedede;">{{translation('kid_no')}} </a></th>
                     <th><a  href="#" class="sort-descs" style="color:#dedede;">{{translation('discount')}} </a></th>
                     <th><a  href="#" class="sort-descs" style="color:#dedede;">{{translation('academic_year')}} </a></th>
 ...
 <script type="text/javascript">
      ...
      /*Script to show table data*/
          ...
          @if(array_key_exists('brotherhood.delete', $arr_current_user_access))    
           ...
           @endif
          {data: 'kid_no', "orderable": false, "searchable":false},
          {data: 'discount', "orderable": false, "searchable":false},
          {data: 'academic_year', "orderable": false, "searchable":false}
          @if(array_key_exists('brotherhood.delete', $arr_current_user_access)||array_key_exists('brotherhood.update', $arr_current_user_access)),
          {
            render : function(data, type, row, meta) 
            {

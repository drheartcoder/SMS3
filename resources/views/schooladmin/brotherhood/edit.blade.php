                            ...
                            <form method="post" onsubmit="return addLoader()"  action="{{$module_url_path}}/update/{{$enc_id}}"  class="form-horizontal" id="validation-form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                             <input type="text" name="kid_no" id="kid_no" class="form-control"  data-rule-number="true" data-rule-required='true' max="100" min="1" placeholder="{{translation('enter')}} {{translation('kid_no')}}" value="{{ $arr_data['kid_no'] }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            <input type="text" name="discount" id="discount" class="form-control"   data-rule-required='true' maxlength="100" placeholder="{{translation('enter')}} {{translation('discount') }}" max="100" value="{{ $arr_data['discount'] }}" />

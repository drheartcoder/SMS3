...
<!-- BEGIN Page Title -->
 <div class="page-title new-agetitle">
    <div>
        <h1><i class="fa {{$module_icon}}"></i>{{$page_title}}</h1>
    </div>
</div>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="row">                                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-8 controls">
                                                <input class="form-control datepikr timepicker-default" name="exam_start_time" placeholder="{{translation('enter')}} {{translation('exam_start_time')}}" type="text" data-rule-required="true" readonly style="cursor: pointer;"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-8 controls">
                                                ...
                                                <option value="">{{translation('select_supervisor')}}</option>
                                            ...
                                            <div class="col-sm-8 col-lg-8 controls">
                                                ...
                                                <div class="green box-new">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 col-lg-8 controls">
                                                            <input class="form-control place" name="place" id="place" placeholder="{{translation('enter')}} {{translation('place')}}" type="text" value="">
                                                        </div>
                                                    </div>    
                                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-8 controls">
                                                ...
                                                <input class="form-control datepikr" id="datepicker" name="exam_date" placeholder="{{translation('enter')}} {{translation('exam_date')}}" type="text" readonly style="cursor: pointer;"  data-rule-required='true'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-8 controls">
                                                <input class="form-control datepikr timepicker-default" name="exam_end_time" placeholder="{{translation('enter')}} {{translation('exam_end_time')}}" type="text"  readonly style="cursor: pointer;" data-rule-required='true'/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-lg-8 controls">
                                                <textarea class="form-control" name="exam_description" placeholder="{{translation('enter')}} {{translation('exam_description')}}" pattern="[a-zA-Z0-9\- àâäèéêëîïôœùûüÿçÀÂÄÈÉÊËÎÏÔŒÙÛÜŸÇ]+$" type="text" data-rule-required='true'></textarea>

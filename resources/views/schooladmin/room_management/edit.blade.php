                            ...
                            <form method="post" onsubmit="return addLoader()"  action="{{$module_url_path}}/update/{{$enc_id}}"  class="form-horizontal" id="validation-form1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            <input type="text" name="tag_name" id="tag_name"  class="form-control" data-rule-required='true' placeholder="{{translation('enter')}} {{translation('tag')}}" value="{{ $arr_data['tag_name'] or '' }}" />
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            <input type="text" name="floor_no" id="floor_no" class="form-control"
                                             ...
                                             data-rule-required='true' placeholder="{{translation('enter')}} {{translation('floor_no')}}"   value="{{ $arr_data['floor_no'] or '' }}"/>
                                            <div id="suggesstion-box"></div>
                                          </div>
                                        <span class="help-block"></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4 controls">
                                          <div class="frmSearch">
                                            <input type="text" name="no_of_rooms" id="no_of_rooms" class="form-control" data-rule-required='true' maxlength="10" 
                                            data-rule-number="true"
                                            placeholder="{{translation('enter')}} {{translation('no_of_rooms')}}" value="{{ $arr_data['no_of_rooms'] or '' }}" data-rule-min="1" />
                                            <div id="suggesstion-box"></div>
                                          </div>
                                        <span class="help-block"></span>
                                    </div>

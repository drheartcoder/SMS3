...
<!-- BEGIN Breadcrumb -->
    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="box">
            ...
            <a href="{{$module_url_path}}/create" >{{translation('add')}} {{translation('academic_year')}}</a> 
            @endif
 ...
 <script type="text/javascript">
          ...
          $(document).ready(function()
          {
           ...
           @endif
          {data: 'academic_year', "orderable": false, "searchable":true},
           {data: 'start_date', "orderable": false, "searchable":true},
           {data: 'end_date', "orderable": false, "searchable":true},
           @if(array_key_exists('academic_year.delete', $arr_current_user_access) )
           {
            render : function(data, type, row, meta) 
            {

...
<head>
    ...
    <title>{{ $site_settings['site_name'] or '' }} {{ config('app.project.role_slug.school_admin_role_slug') }} {{translation('login',$locale)}}</title>
    <!-- ======================================================================== -->
        ...
        <div class="flex-main">
            <div class="login-container">
                        ...
                        <div class="login-content">
                            <!-- BEGIN Login Form -->
                            <form id="form-login" action="{{ url('/') }}/{{ config('app.project.role_slug.school_admin_role_slug') }}/process_login" method="post">
                            ...
                            <form id="form-forgot" style="display:none" action="{{ url($school_admin_panel_slug.'/process_forgot_password') }}" method="post">
                                {{ csrf_field() }}

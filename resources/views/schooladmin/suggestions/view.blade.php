  ...
  <ul class="breadcrumb">
     ...
     @if($role==config('app.project.role_slug.school_admin_role_slug'))
      ...
      <i class="fa fa-thumbs-up faa-vertical animated-hover">
        ...
        <a href="{{ $module_url_path}}/{{\Request::segment(4)}}" class="call_loader">{{ $module_title or ''}}
        </a>
      @endif
    </span>  
    <span class="divider">
...
<div class="page-title new-agetitle">
    <div>
        <h1><i class="fa fa-list"></i> {{ isset($page_title)?$page_title:"" }}</h1>
    </div>
</div>
<!-- END Page Title -->
                ...
                <div class="col-md-12">
                 <div class="details-infor-section-block">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-9 col-lg-4 controls">
                        <?php  
                          $first_name = isset($suggestions['get_user_details']['first_name'])?$suggestions['get_user_details']['first_name']:'-';

                          $last_name  = isset($suggestions['get_user_details']['last_name'])?ucfirst($suggestions['get_user_details']['last_name']):'-';
                        ?>
         ...
         <div class="clearfix"></div><br/>
            ...
            @if($role==config('app.project.role_slug.school_admin_role_slug'))
             <div class="form-group back-btn-form-block">
               <div class="controls">
                  <a href="{{ $module_url_path}}/{{\Request::segment(4)}}" class="btn btn-primary" style="float: right;margin-top: 20px;" > <i class="fa fa-arrow-left"></i> {{translation('back')}} </a>
               </div>
            </div>
            @endif 
         {!! Form::close() !!}

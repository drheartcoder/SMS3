                ...
                @if(sizeof($arr_tasks)>0)
                  ...
                  @foreach($arr_tasks as $data)
                      <?php
                            ...
                            if($total_count!=0){
                              $percentage = round(($complete_count/$total_count) *100,2);
                            }
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          @elseif($data['get_user']['status'])
                             <select class="form-control" onchange="changeTaskStatus('{{$data['get_user']['id']}}')" id="professor_status_{{$data['get_user']['id']}}">
                        ...
                        <td>
                          ...
                          @if(array_key_exists('task.update', $arr_current_user_access))  
                            ...
                            @else
                              <a style="position: relative;" class="orange-color" href="javascript:void(0)" title="{{translation('edit')}}" ><i class="fa fa-edit" ></i><i class="fa fa-ban fa-stack-2x text-danger"></i></a>  
                            @endif  
                          @endif
                          @if(array_key_exists('task.delete', $arr_current_user_access))  
                            @if($data['added_by']==$current_user)
                            ...
                            @else
                              <a style="position: relative;" class="red-color" href="javascript:void(0)" title="{{translation('delete')}}" ><i class="fa fa-trash" ></i><i class="fa fa-ban fa-stack-2x text-danger"></i></a>
                            @endif  
                          @endif
...
function changeStatus(id)
  ...
  function changeTaskStatus(id){
    var status = $("#professor_status_"+id).val();
      $.ajax({

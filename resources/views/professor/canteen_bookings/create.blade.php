...
<div id="breadcrumbs">
  <ul class="breadcrumb">
    <li>
      ...
      <a href="{{ url($professor_panel_slug.'/dashboard') }}"> {{translation('dashboard')}}
      </a>
    </li>
                      ...
                      <div class="clearfix"></div><br/>
                        @if(isset($arr_daily_meal) && count($arr_daily_meal)>0)
                          @foreach($arr_daily_meal as $key => $daily_meal)
                               ...
                               <div class="col-sm-6 col-md-4 col-lg-4 cart_item attendance-create-table-section">
                                ...
                                @if(isset($arr_cart_data) && count($arr_cart_data)>0)
                                 ...
                                 <div class="content-list-li">
                                    <div class="img-content-prnt">
                                      <?php
                                          $file_name = $base_path.$data['get_product_details']['product_image'];
                                        ?>

                                      @if(isset($data['get_product_details']['product_image']) && $data['get_product_details']['product_image'] != '' && file_exists($file_name))

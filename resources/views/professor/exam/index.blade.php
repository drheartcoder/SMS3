...
<div class="page-title new-agetitle">
    <div>
        <h1><i class="fa fa-book"></i>{{translation('exam')}}</h1>
    </div>
</div>
<!-- END Page Title -->
        ...
        <div class="box  box-navy_blue">
            <div class="box-title">
                ...
                <div class="box-tool">
                    ...
                    @endif
                    @if (array_key_exists('exam.create', $arr_current_user_access))
                    <a href="{{ $module_url_path.'/create' }}" title="{{translation('add')}} {{$page_title }}">{{translation('add')}} {{ $page_title }}</a>
                    @endif
                    ...
                    <table class="table table-advance" id="table_module">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting_disabled">
                                    <a class="sort-descs" href="#" style="color:#dedede;">{{translation('exam_type')}}</a><br>

                                </th>
                                <th class="sorting_disabled">
                                    <a class="sort-descs" href="#" style="color:#dedede;">{{translation('exam_name')}}</a><br>
                                ...
                                <th class="sorting_disabled">
                                    <a class="sort-descs" href="#">{{translation('exam_period')}}</a><br>

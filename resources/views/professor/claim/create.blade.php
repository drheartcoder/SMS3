                  ...
                  <form method="POST" action="{{$module_url_path}}/store" onsubmit="return addLoader()" id="validation-form1" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" >
                       {{ csrf_field() }}  
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-9 col-md-8 col-lg-4 controls">
                                  <input class="form-control" name="student_national_id" id="student_national_id" type="text" placeholder="{{translation('enter')}} {{translation('student')}} {{translation('national_id')}}"  pattern="^[A-Za-z0-9]*$" readonly />
                              </div>
                          </div><div class="clearfix"></div>
                          ...
                          <div class="col-sm-8 col-sm-offset-4 col-lg-9 col-lg-offset-3">
                              ...
                              <input type="submit" name="submit" value="{{translation('save')}}" id="submit_button" class="btn btn-primary">
                          </div>
...
$('#student_name').on('change',function(){
    ...
    if(student_id!='')
    {
        $("#student_national_id").empty();
        $.ajax({
          url  :"{{ $module_url_path }}/get_student_NationalId",
          type :'get',
          data :{'_token':'<?php echo csrf_token();?>','student_id':student_id},
          success:function(data){
                console.log(data);
                 $("#student_national_id").val(data);

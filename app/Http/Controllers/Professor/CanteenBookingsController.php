...
class CanteenBookingsController extends Controller
{
    ...
    {   
        ...
        $this->module_url_path              = url(config('app.project.professor_panel_slug')."/canteen_bookings");
        
        $this->module_title                 = translation("canteen_bookings");
        $this->module_view_folder           = "professor.canteen_bookings";
    ...
    public function print_doc($enc_id)
    {
        ...
        $this->arr_view_data['module_icon']          = $this->module_icon;
        $this->arr_view_data['view_icon']            = $this->view_icon;
        $this->arr_view_data['professor_panel_slug'] = $this->professor_panel_slug;
    ...
    public function status($enc_id)
    {
        ...
        if($obj_records)
        {
            ...
            if($records)
            {
                Flash::success($this->module_title.' '.translation('deliverd_successfully'));
            }
            else
            {
                Flash::success($this->module_title.' '.translation('deliverd_successfully'));

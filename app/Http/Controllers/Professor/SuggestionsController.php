...
class SuggestionsController extends Controller
{
                                ...
                                )
    {
        ...
        $this->arr_view_data                = [];
        $this->module_url_path              = url(config('app.project.professor_panel_slug')."/suggestions");
        
        $this->module_title                 = translation("suggestions");
        $this->module_url_slug              = translation("suggestions");

        $this->module_view_folder           = "professor.suggestions";
    ...
    public function store(Request $request)
    {
        ...
        if($create_data)
        {
            if(array_key_exists('suggestions.app',$this->permissions))
            {
                ...
                $arr_notification['title']              =  'New Suggestion Added: '.ucwords($this->first_name.' '.$this->last_name).' Professor added new suggestion';

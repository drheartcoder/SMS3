...
class CalendarController extends Controller
{
                                ...
                                )
    {
        ...
        $this->arr_view_data                = [];
        $this->module_url_path              = url(config('app.project.parent_panel_slug')).'/calendar';
        ...
        $this->module_view_folder           = "parent.calendar";
    ...
    public function index()
    {
        ...
        if($obj_events)
        {
            ...
            foreach($arr as $value)
            {
                ...
                if(in_array(config('app.project.parent_panel_slug'),$users) || in_array(config('app.project.student_panel_slug'),$users))
                {
                    $flag=0;

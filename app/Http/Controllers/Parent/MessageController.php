...
class MessageController extends Controller
{
    public function __construct(CommonDataService $CommonDataService){
    	...
    	$this->arr_view_data                = [];
        $this->module_url_path              = url(config('app.project.parent_panel_slug')).'/message';
        $this->module_title                 = translation('message');
 
        $this->module_view_folder           = "parent.message";
    ...
    public function index(){
    	...
    	$arr_professors =[];
    	$obj_professors = $this->CommonDataService->get_professor_by_level_class($this->level_class_id);
        ...
        $this->arr_view_data['level_class']  = $this->level_class_id;

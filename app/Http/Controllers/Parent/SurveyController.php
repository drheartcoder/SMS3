...
class SurveyController extends Controller
{
                                ...
                                )
    {
		...
		$this->arr_view_data                = [];
        $this->module_url_path              = url(config('app.project.parent_panel_slug')).'/survey';
        $this->module_title                 = translation('survey');
 
        $this->module_view_folder           = "parent.survey";
        ...
        $obj_permissions = SchoolAdminModel::with('notification_permissions','get_user_details')
                   ...
                   if(array_key_exists('survey.app',$this->permissions))
                    {
                        ...
                        $arr_notification['title']              =   'Survey Response: '.ucwords($this->first_name.' '.$this->last_name).' '.ucwords(config('app.project.role_slug.parent_role_slug')).' responded on survey';

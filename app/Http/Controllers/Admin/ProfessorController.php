...
class ProfessorController extends Controller
{
                                ...
                                )
    {
        ...
        $this->arr_view_data                = [];
        $this->module_url_path              = url(config('app.project.admin_panel_slug')."/users/professor");
    ...
    {     
        ...
        if($request->has('search') && $search_term!="")
        {
            $obj_user = $obj_user->WhereRaw("( (".$user_details.".email LIKE '%".$search_term."%') ")
                                 ->orWhereRaw("(".$professor.".school_id LIKE '%".$search_term."%') ")

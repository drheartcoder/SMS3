...
class SchoolController extends Controller
{
                                ...
                                )
    {
        ...
        $this->module_url_path                = url(config('app.project.role_slug.school_admin_role_slug')."/school");
        ...
        $this->module_view_folder             = "schooladmin.school";
        $this->module_title                   = translation('school_profile');
    ...
    {   
       ...
       $validator = Validator::make($request->all(),$arr_rules,$messages);
        ...
        if($request->hasFile('image'))
        {
            ...
            if(($arr_image_size[0] < $minWidth) && ($arr_image_size[1] < $minHeight))
            {
        ...
        \Session::put('school_id',$school_no);
    ...
    public function edit()
    {
        ...
        $obj_data = $this->SchoolProfileModel->with('translations')->where('school_no',$school->school_id)->get();
     
        if($obj_data)
        {
            $arr_data = $obj_data->toArray();
           /* foreach ($arr_data as $key => $value) {
                $data[$key]   =   $this->arrange_locale_wise($value['translations']);
            }
            
            $arr_data['translations'] = $data;*/
        ...
        $this->arr_view_data['enc_id']                  = $this->user_id;
        $this->arr_view_data['image_path']              = $this->user_profile_base_img_path ;
    ...
    {   
       ...
       if($validator->fails())
        ...
        $school =   $this->SchoolAdminModel->where('user_id',$this->user_id)->first();         
